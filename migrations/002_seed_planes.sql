...
INSERT INTO planes_subscription (nombre, descripcion, equipos_max, clusters_ia_mes, precio)
SELECT 'Small Team', 'Para equipos que necesitan más retrospectivas. 1 equipo, 30 clusters IA por mes.', 1, 30, 9.00
WHERE NOT EXISTS (SELECT 1 FROM planes_subscription WHERE nombre = 'Small Team');

INSERT INTO planes_subscription (nombre, descripcion, equipos_max, clusters_ia_mes, precio)
SELECT 'Enterprise', 'Para organizaciones con múltiples equipos. 10 equipos, 500 clusters IA por mes.', 10, 500, 29.00
